        ...
        <div class="check">
            <div class="container">	 
                ...
                <div class="col-md-9 cart-items">
                    <h1>My Shopping Bag (<%=cart.getTotalitem()%>)</h1>
                    
                        
                    <%
                        ArrayList<shose> list = cart.getCart();
                        for (int i = 0; i < list.size(); ++i) {
                            shose temp = list.get(i);
                    ...
                    <div class="cart-header2">
                        <div class="close2">
                                ...
                                <a href="controller?action=delete&id=<%=temp.getID_shose()%>" title="">Delete</a>
